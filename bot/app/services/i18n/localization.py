...
TEXTS_RU: Dict[str, str] = {
    ...
    "ai.error.warming_up": "ИИ запускается (холодный старт). Подождите 1-3 минуты и попробуйте снова.",
...
TEXTS_EN: Dict[str, str] = {
    ...
    "ai.error.warming_up": "AI is starting up (cold start). Please wait 1-3 minutes and retry.",
...
TEXTS_AR: Dict[str, str] = {
    ...
    "ai.error.warming_up": "يتم تشغيل الذكاء الاصطناعي الآن (بدء بارد). الرجاء الانتظار 1-3 دقائق ثم إعادة المحاولة.",
